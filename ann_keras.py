...
This repository contains examples used in blogpost - This repository contains examples used in blogpost
 - http://rubikscode.net/2018/02/12/implementing-simple-neural-network-using-keras-with-python-example/
"""
